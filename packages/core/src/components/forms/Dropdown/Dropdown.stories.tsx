    ...
    return (
      <ScrollView style={{ padding: 20 }}>
        ...
        <Text style={{ color: "#666", marginBottom: 24 }}>
          Dropdowns support all 12 placements with automatic collision detection
        </Text>
            ...
            return (
              <View key={placement.value}>
                ...
                <Dropdown
                  onChange={setValue}
                  options={fruitOptions}
                  placeholder={`Opens ${placement.label.toLowerCase()}`}
    ...
    return (
      <View style={{ flex: 1, padding: 20, justifyContent: "space-between" }}>
        ...
        <View style={{ gap: 16 }}>
          ...
          <Text color="secondary" style={{ marginBottom: 16 }}>
            {`This dropdown automatically opens upward because there's no space below!`}
          </Text>
          <Dropdown
      ...
      <ScrollView style={{ gap: 20, padding: 20 }}>
        <View style={{ gap: 16 }}>
          ...
          <Text color="secondary" style={{ marginBottom: 8 }}>
            {`Using placement="top-start" prop - will flip to bottom if not enough space`}
          </Text>
          <Dropdown
            label="Forced Top-Start Position"
            onChange={setTopStartValue}
            options={fruitOptions}
            placeholder="Opens upward (or flips)"
            placement="top-start"
            value={topStartValue}
          />
        </View>
        ...
        <View style={{ gap: 16 }}>
          ...
          <Text color="secondary" style={{ marginBottom: 8 }}>
            {`Using placement="top-end" prop - aligned to end`}
          </Text>
          <Dropdown
            label="Forced Top-End Position"
            onChange={setTopEndValue}
            options={fruitOptions}
            placeholder="Opens upward (end aligned)"
            placement="top-end"
            value={topEndValue}
          />
        </View>
...
export const MinHeightBehavior: Story = {
  render: () => {
    return (
      <View style={{ flex: 1, padding: 20, justifyContent: "space-between", minHeight: 700 }}>
        <View style={{ gap: 16 }}>
          ...
          <Text color="secondary" style={{ marginBottom: 8 }}>
            Will only flip if less than 50px available
          </Text>
          <Dropdown
            label="Small minHeight"
            minHeight={50}
            onChange={() => {}}
            options={fruitOptions.slice(0, 3)}
            placement="top-start"
            placeholder="Opens upward easily"
          />
        </View>
        ...
        <View style={{ gap: 16 }}>
          ...
          <Text color="secondary" style={{ marginBottom: 8 }}>
            Will flip if less than 200px available
          </Text>
          <Dropdown
            label="Large minHeight"
            minHeight={200}
            onChange={() => {}}
            options={countryOptions}
            placement="bottom-start"
            placeholder="May flip to fit"
            searchable
          />
        </View>
      </View>
...
export const MultiSelectWithPlacement: Story = {
  render: () => {
    const [selected, setSelected] = useState<string[]>([]);
    ...
    return (
      <View style={{ gap: 16, padding: 20, width: "100%", maxWidth: 400 }}>
        <Dropdown<string>
          label="Multi-Select with Top Placement"
          multiple
          onChange={setSelected}
          options={fruitOptions}
          placement="top-start"
